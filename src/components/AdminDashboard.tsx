...
export const AdminDashboard = () => {
  ...
  if (!isLoggedIn) {
    return (
      <div className="min-h-[60vh] flex items-center justify-center p-4">
        ...
        >
          <Card className="border-none shadow-[0_40px_80px_-15px_rgba(0,0,0,0.6)] bg-card overflow-hidden rounded-[2.5rem]">
            ...
            <CardHeader className="pb-6 sm:pb-8 pt-8 sm:pt-10 px-6 sm:px-10 text-center">
              ...
              <CardTitle className="text-2xl sm:text-3xl font-black tracking-tighter uppercase italic text-primary">Neural Gate</CardTitle>
              <CardDescription className="text-secondary font-medium text-xs sm:text-sm">Authentication required to access the central terminal.</CardDescription>
            </CardHeader>
            <CardContent className="px-6 sm:px-10 pb-10 sm:pb-12 space-y-6 sm:space-y-8">
              <form onSubmit={handleLogin} className="space-y-6">
                <div className="space-y-3">
                  <Label className="text-[10px] font-black uppercase tracking-[0.2em] text-secondary ml-1">Access Key</Label>
                  <div className="relative group">
                    <Lock className="absolute left-5 top-1/2 -translate-y-1/2 h-5 w-5 text-secondary group-focus-within:text-blue-500 transition-colors duration-500" />
                    <Input
                      type="password"
  ...
  return (
    <div className="space-y-10 animate-in fade-in duration-700 max-w-[90rem] mx-auto pb-20">
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6 pb-8 p-4 sm:p-0">
        <div className="space-y-2 text-center lg:text-left">
          <div className="flex flex-col lg:flex-row items-center gap-4">
            ...
            <h2 className="text-3xl sm:text-4xl font-black tracking-tighter uppercase italic text-primary">Central <span className="text-blue-500">Terminal</span></h2>
          </div>
          <p className="text-secondary text-xs sm:text-sm font-medium">Monitoring real-time neural feedback and system performance matrix.</p>
        </div>
        ...
        <div className="flex items-center gap-3">
          <Button
            ...
            className="h-12 px-6 rounded-xl font-black uppercase tracking-widest text-[11px] border border-theme text-primary hover:bg-bg transition-all duration-200"
          >
            Terminal Logout
          </Button>
        </div>
      ...
      <Card className="border-none shadow-2xl bg-card overflow-hidden relative rounded-[2rem] p-1">
          ...
          <CardHeader className="pb-2 pt-6 px-6 relative z-10">
            <CardTitle className="text-[10px] font-black uppercase tracking-[0.2em] text-secondary">Core Visitors</CardTitle>
          </CardHeader>
        ...
        <Card className="border-none shadow-2xl bg-card overflow-hidden relative rounded-[2rem] p-1">
          ...
          <CardHeader className="pb-2 pt-6 px-6 relative z-10">
            <CardTitle className="text-[10px] font-black uppercase tracking-[0.2em] text-secondary">Active Cycle Sessions</CardTitle>
          </CardHeader>
          <CardContent className="px-6 pb-6 relative z-10">
            <div className="text-5xl font-black tracking-tighter text-primary">
        ...
        <Card className="border-none shadow-2xl bg-card overflow-hidden relative rounded-[2rem] p-1">
          ...
          <CardHeader className="pb-2 pt-6 px-6 relative z-10">
            <CardTitle className="text-[10px] font-black uppercase tracking-[0.2em] text-secondary">Feedback Packets</CardTitle>
          </CardHeader>
          <CardContent className="px-6 pb-6 relative z-10">
            <div className="text-5xl font-black tracking-tighter text-primary">
              {feedback.length}
        ...
        <Card className="border-none shadow-2xl bg-card overflow-hidden relative rounded-[2rem] p-1">
          ...
          <CardHeader className="pb-2 pt-6 px-6 relative z-10">
            <CardTitle className="text-[10px] font-black uppercase tracking-[0.2em] text-secondary">Sync Status</CardTitle>
          </CardHeader>
          <CardContent className="px-6 pb-6 relative z-10">
            <div className="text-4xl font-black tracking-tighter text-primary uppercase italic">
              ONLINE
            </div>
            <div className="flex items-center gap-2 mt-2">
      ...
      <div className="flex flex-wrap items-center gap-4 pt-10">
        <div className="relative flex-1 w-full sm:min-w-[300px] group">
          <Search className="absolute left-5 top-1/2 -translate-y-1/2 h-5 w-5 text-secondary group-focus-within:text-blue-500 transition-colors duration-500" />
          <input
            type="text"
            placeholder="SCAN FEEDBACK MATRIX..."
            value={searchTerm}
            onChange={(e) => setSearchTerm(e.target.value)}
            className="w-full h-14 pl-14 pr-6 rounded-[1.5rem] border-2 border-theme bg-bg focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 outline-none text-sm font-black uppercase tracking-widest text-primary transition-all duration-500"
          />
        </div>
        
        <Select value={filterType} onValueChange={(v: any) => setFilterType(v)}>
          <SelectTrigger className="h-14 w-44 rounded-[1.5rem] border-2 border-theme bg-bg font-black text-[11px] uppercase tracking-widest text-primary focus:ring-blue-500">
            <Filter className="h-4 w-4 mr-3 text-blue-500" />
            <SelectValue placeholder="Matrix Filter" />
          </SelectTrigger>
          <SelectContent className="rounded-2xl bg-card border-theme text-primary">
        ...
        <Button
          ...
          className="h-14 px-6 rounded-[1.5rem] border border-theme font-black uppercase tracking-widest text-[11px] gap-3 text-primary hover:bg-bg transition-all duration-200 shadow-xl"
        >
