...
import { LogOut, MessageSquare, LayoutDashboard, Star, Trash2, Download, Filter, Edit2, Check, X, ShieldAlert } from "lucide-react";
                ...
                {filtered.length === 0 ? (
                  ...
                  filtered.map((f: any) => (
                    <motion.div 
                      layout
                      key={f.id} 
                      className="p-5 rounded-2xl bg-white dark:bg-slate-900 shadow-sm border border-slate-200 dark:border-white/5 space-y-4 hover:shadow-md transition-shadow relative group"
                    >
